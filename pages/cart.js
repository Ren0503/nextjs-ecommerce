        ...
        <>
            ...
            <div className="flex flex-col items-center pb-10">
                <Head>
                    ...
                    <meta name="description" content={`E Commerce - Shopping cart`} />
                    <meta property="og:title" content="E Commerce - Cart" key="title" />
                </Head>
                                            ...
                                            return (
                                                <div className="border-b py-10" key={item.id}>
                                                    ...
                                                    <div className="flex items-center flex md:hidden">
                                                        ...
                                                        <div role="button" onClick={() => removeFromCart(item)} className="m-0 ml-10 text-gray-900 text-s cursor-pointer mr-2">
                                                            <FaTimes />
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <Link href="/checkout" className="flex flex-1 justify-end">
                            <a aria-label="checkout">
                                <div className="cursor-pointer flex items-center">
                                    <p className="text-gray-600 text-sm mr-2">Proceed to checkout</p>
