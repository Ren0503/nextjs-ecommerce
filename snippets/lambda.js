// https://stripe.com/docs/payment/without-card-authentication
...
exports.handler = async event => {
    ...
    try {
        const intent = await stripe.paymentIntents.create({
            ...
            // If the payment requires any follow up action from the customer
            // like two-factor authentication
            // Stripe will error and you will need to prompt them for a new payment method.
